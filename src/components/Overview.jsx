...
function Overview() {
  ...
  return (
    <div className="bg-[#f1f1f1] px-[6%] py-[5%]">
      ...
      <div className="flex flex-row justify-between w-[100%] mt-10 items-start px-10">
        <div className="w-full"></div>
        <div className="align-middle flex flex-col justify-center gap-5  items-start p-10 h-[300px] bg-white shadow-lg rounded-lg w-[100%]">
          <p className="text-black text-center font-semibold text-[14px]">
            Transaction History
          </p>
        </div>
